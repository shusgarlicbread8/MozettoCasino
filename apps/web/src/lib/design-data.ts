...
export const landingSteps = [
  { n: "01", k: "Choose a game", t: "Texas Hold’em (heads-up), Poker Classic (6-max), Omaha, or Short Deck. Six leagues, from $10 upward." },
...
export const landingGames = [
  { name: "Texas Hold’em", glyph: "♠", color: "#00E676", ring: "rgba(0,230,118,.45)", type: "PvP", typeColor: "#00E676", art: "radial-gradient(120% 130% at 50% 22%,rgba(0,230,118,.15),#0A0A0A 72%)", desc: "Heads-up only. Ranked 1v1 matches with equal stacks — two seats, one opponent." },
  { name: "Poker (Classic)", glyph: "♥", color: "#8FE3D2", ring: "rgba(143,227,210,.45)", type: "PvP", typeColor: "#00E676", art: "radial-gradient(120% 130% at 50% 22%,rgba(143,227,210,.15),#0A0A0A 72%)", desc: "Multiway 6-max on the same engine. Fill open seats or open a new table in your league." },
