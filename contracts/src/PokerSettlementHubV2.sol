...
/// @title PokerSettlementHubV2 — attested settlement into ArenaVaultV2
contract PokerSettlementHubV2 is Ownable, EIP712 {
    ...
    constructor(address vault_, address owner_) Ownable(owner_) EIP712("MozettoPokerSettlement", "2") {
    ...
    function settle(
        ...
        vault.applyCheckpoint(
            settlement.sessionId, settlement.finalSequence, settlement.balanceRoot, settlement.eventRoot
        );
